...
public class HttpInterceptor implements Interceptor {
     ...
     */
    public HttpInterceptor(int retryCount,Map headerMap) {
        this(Logger.DEFAULT, retryCount,headerMap);
    }
     ...
     * @param retryCount the retry count
     */
    public HttpInterceptor(Logger logger, int retryCount,Map headerMap) {
        this.logger = logger;
